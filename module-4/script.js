...
(function() {
    ...
    var mappingFunction = function(name) {
    ...
    var mappedNames = names.map(mappingFunction);
    for (i = 0; i < mappedNames.length; i++) {
        console.log(mappedNames[i]);
    }

    var reducedNames = names.reduce(function(accumulator, name) {
        var firstLetter = name.charAt(0);
        if (firstLetter.toLowerCase() === 'j') {
    ...
    for (i = 0; i < reducedNames.hello.length; i++) {
        console.log(reducedNames.hello[i]);
    }
    for (i = 0; i < reducedNames.bye.length; i++) {
